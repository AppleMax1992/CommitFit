...
def get_augmented_samples(*args, **kwargs) -> None:
    warnings.warn(
        "`get_augmented_samples` has been deprecated and will be removed in v1.0.0 of CommitFit. "
...
class CommitFitDataset(TorchDataset):
    """CommitFitDataset
